...
Перед запуском сервиса убедитесь, что файл similar.parquet находится в репозитории (см. файл README.md),
далее выполните команду, находясь в корневой папке проекта:
