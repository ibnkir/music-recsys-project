...
3. __Запуск и тестирование сервиса__
    ...
    - `test_service.py` - вспомогательный сервис для тестирования различных пользовательских сценариев.
    
    Для запуска сервисов необходимо выполнить 4 команды (по одной на каждый сервис) в 4-х разных терминалах, находясь в папке проекта:
    ```
    ...
    Далее выполните тестовые запросы, перейдя по следующим ссылкам:
    ...
    - Получение первых 10 смешанных персональных рекомендаций по оффлайн- и онлайн-истории пользователя с user_id=617032<br>
