...
В рамках проекта были проведены анализ и предобработка данных, сгенерированы рекомендации нескольких типов и разработан веб-сервис на базе FastAPI для их получения.
